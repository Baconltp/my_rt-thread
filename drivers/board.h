 ...
 * Change Logs:
 * Date           Author       Notes
 * 2021-01-19     RealThread   first version
 */
...
#define CHIP_SERIES_STM32L0
#define CHIP_NAME_STM32L071KB
...
#define BSP_CLOCK_SYSTEM_FREQ_MHZ         ((int32_t)32)
...
#define BSP_I2C3_SDA_PIN    GET_PIN(B, 4)
#endif
/*-------------------------- I2C CONFIG END --------------------------*/
